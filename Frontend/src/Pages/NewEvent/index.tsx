...
export default function EventPage() {
  ...
  return (
    <div className="flex h-full bg-violet-100 relative relative">
      ...
      <aside className="w-64 h-full bg-white border-r shadow-md p-4 hidden md:block">
      ...
      <main className="flex flex-col p-8 ">
        ...
        <div className="w-full max-w-xl mx-auto px-10 space-y-10">
          ...
          {/* flyer upload */}
            ...
            <div className="bg-white rounded-sm p-4 w-full space-y-6">
            <form className="space-y-4 max-w-lg items-center justify-center">
                  <div>
              ...
              <div>
              <button className="bg-secondary text-white font-bold p-2 rounded-lg items-center justify-center w-full hover:bg-orange-100 hover:text-secondary transition duration-300 ">
                Create Event
              </button>
              </div>
        </div>
