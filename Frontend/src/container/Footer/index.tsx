    ...
    <div className="bg-primary text-gray-300 font-light text-sm px-8 py-6 w-100% ">
      <div className="flex justify-between max-lg:flex-col">
        <div className="w-100 mt-5">
          ...
          <NavLink to={"/"} className="hover:text-secondary underline">www.planvibes.com</NavLink>
        </div>
        <div className="mt-5">
          <h1 className="font-bold mb-3 ">Important Links</h1>
          <ul>
            <li className="mb-1 flex items-center gap-2"><GoDotFill />Home</li>
            <li className="mb-1 flex items-center gap-2"><GoDotFill />About</li>
            <li className="mb-1 flex items-center gap-2"><GoDotFill />Browse Events</li>
            <li className="mb-1 flex items-center gap-2"><GoDotFill />Login</li>
          </ul>
        </div>
        <div className="mt-5">
